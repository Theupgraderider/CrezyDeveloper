...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Theupgraderider:ASHISHXLR8@cluster0.hg0grvs.mongodb.net/?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "crezyboters")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Telegram_files')

# Channel Button Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/movieshub62')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/Mhubnetwork')
...
RQST_LOG_CHANNEL = int(environ.get('RQST_LOG_CHANNEL', -1001859923275))

# Bot Options
P_TTI_SHOW_OFF = is_enabled((environ.get('P_TTI_SHOW_OFF', "True")), True)
IMDB = is_enabled((environ.get('IMDB', "True")), True)
SINGLE_BUTTON = is_enabled((environ.get('SINGLE_BUTTON', "True")), True)
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", '<b>@Mhubnetwork {file_name}\n\n\n{file_size} </b>')
...
URL_SHORTNER_WEBSITE_API = environ.get('URL_SHORTNER_WEBSITE_API', '1b4a8a6466858c3e2391ca866e112f3401322730')
